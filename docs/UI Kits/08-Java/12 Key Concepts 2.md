...
| Moderator | - | - Change scope of participant.\n- Update group\n- Kick & Ban Participants\n- Send & Receive Messages & Calls | 
...
For more information, you can refer to the [Message structure and hierarchy guide](https://www.cometchat.com/docs/v3/more/overview-message-structure-and-hierarchy).